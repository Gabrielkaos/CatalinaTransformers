...
def train():
    ...
    # data
    train_loader = DataLoader(TransformerData(x, y, label, tokenizer_src), batch_size=batch_size, shuffle=False)
    ...
    for epoch in range(num_epoch):
        ...
        print(
            f"[EPOCH] Epoch:{epoch + 1}/{num_epoch}, Accumulated Loss:{(running_loss/added):.4f}")
